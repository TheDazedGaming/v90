...
function clearBoss(stage, eim, curMap) {
	eim.setProperty(stage + "stageclear", "true");
    eim.showClearEffect(true);
    eim.gainlostPoints(5);
	eim.dropMessage(6, "You have gained 5 Lost Points");
    eim.linkToNextStage(stage, "kpq", curMap);  //opens the portal to the next map
}
function clearStage(stage, eim, curMap) {
    eim.setProperty(stage + "stageclear", "true");
    eim.showClearEffect(true);
    eim.gainlostPoints(1);
	eim.dropMessage(6, "You have gained 1 Lost Point");
    eim.linkToNextStage(stage, "kpq", curMap);  //opens the portal to the next map
}
