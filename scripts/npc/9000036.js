...
function start() {
    ...
    var options = ["Pendants","Face accessories","Eye accessories","Medals","Rings","Belts"];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selectedType == 0) { //pendant refine
            ...
            var matSet = [[4011007, 4011008, 4021009], [7777, 7777]];
            var matQtySet = [[1, 1, 1], [7777, 7777]];
            var costSet = [10000, 7777];
        }
