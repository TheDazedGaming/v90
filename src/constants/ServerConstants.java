...
public class ServerConstants {
    ...
    public static final boolean DB_CONNECTION_POOL = false;      //Installs a connection pool to hub DB connections. Set false to default.
    ...
    public static final int MAP_DAMAGE_OVERTIME_INTERVAL = 10000;//Interval in seconds between map environment damage (e.g. El Nath and Aqua Road surrondings).
