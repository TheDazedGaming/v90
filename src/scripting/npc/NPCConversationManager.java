...
public class NPCConversationManager extends AbstractPlayerInteraction {
	...
	public MapleStatEffect getItemEffect(int itemId) {
        ...
        public void modifyNX(int amount, int type) {
            ...
            if (amount > 0) {
                getClient().getSession().write(MaplePacketCreator. serverNotice(6, "You have gained (+" + amount +") Nexon Cash. Spend it wisely."));
            } else {
                getClient().getSession().write(MaplePacketCreator. serverNotice(6, "You have lost (" + (amount) +") Nexon Cash."));
            }
        }
        ...
        public void gainReborns(int gain){
	...
	public void doGachapon() {
		int[] maps = {100000000, 101000000, 102000000, 103000000, 105040300, 540000000, 800000000, 809000101, 809000201, 600000000, 120000000};
